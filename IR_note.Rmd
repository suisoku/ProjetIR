...
qplot(sentiment, data=new_result[1:8,], weight=count, geom="bar",fill=sentiment)+ggtitle("Graphe d'analyse des Sentiments de tous le discours")
qplot(sentiment, data=new_result[9:10,], weight=count, geom="bar",fill=sentiment)+ggtitle("Graphe d'analyse de tous le discours Positif et Negatif")
#Pour ces deux graphe on a analys? les termes utiliser dans les discours sans differencier entre homme et femme. On va analyser les sentiments en discours des gens politique en general. le premier graphe nous permet de deduire que il utiliser les mots de confiance le plus souvent apres on voit les termes d'anticipation et de peur.
#Pour le deuxieme graphe il nous illustre que les termes positifs domine sur les termes negatifs dans les discours.
